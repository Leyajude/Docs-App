...
function Chagebox() {
  ...
  return (
    <>
      <div className="container mt-5" style={{color:'white', backgroundColor:''}}>
        <h2 className='mt-5'>{data.title}</h2>
        <ReactQuill className='mt-0' style={{height:'100px'}} placeholder='Enter details' theme="snow" value={displayValue} onChange={(e)=>handleChange(e)} />
      </div>
    </>
  )
}
